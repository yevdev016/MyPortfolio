        ...
        <section className="hero-section">
            <div className="hero-text">
                ...
                <div className='tech-stack'>
                    <div className="tech-badge">HTML5
                        <img src={html} alt="HTML" />
                    </div>
                    <div className="tech-badge">CSS3
                        <img src={css} alt="CSS" />
                    </div>
                    ...
                    <div className="tech-badge">Node.js
                        <img src={node} alt="Node" />
                    </div>
                    <div className="tech-badge">Express
                        <img src={express} alt="Express" />
                    </div>
                    <div className="tech-badge">PostgreSQL
                        <img src={postgre} alt="Postgre" />
                    </div>
                    <div className="tech-badge">
                        <svg width="60" height="28" viewBox="0 0 90 28" fill="none" xmlns="http://www.w3.org/2000/svg">
